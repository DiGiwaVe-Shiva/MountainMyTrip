    ...
    <>
      ...
      <section className="max-w-7xl mx-auto px-4 py-4 flex flex-col md:flex-row gap-10">
        ...
        <div className="flex-1">
          ...
          <p className="text-gray-600 mb-4">
            The Kedarkantha Trek is a classic winter trek through dense pine
            forests, charming campsites, and a summit climb with unforgettable
            Himalayan views. Ideal for first-time trekkers and snow lovers.
          </p>
                ...
                return (
                  ...
                  >
                    <button
                      ...
                      className="w-full px-4 py-4 flex justify-between rounded-xl items-center hover:bg-gray-100"
                    >
                      <span className="text-base md:text-lg font-semibold text-gray-800 text-left break-words whitespace-normal">
                        {item.title}
                      </span>
                      {isOpen ? (
                        <FaChevronUp className="text-orange-500" />
        ...
        <div className="w-full md:w-[350px] lg:w-[400px] flex-shrink-0">
          <div className="sticky top-24">
            <div className="bg-white shadow-lg rounded-2xl p-6 border">
              ...
              <div className="text-xl font-bold text-red-600 mb-1">
                Starting From:{" "}
                <span className="text-gray-600">₹7,499</span>/Per Person
              </div>
