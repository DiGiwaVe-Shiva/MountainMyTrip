...
export default function ContactForm() {
  ...
  return (
    <>
      ...
      {/* Contact Section */}
      <section className="bg-gray-50 py-12 px-4 sm:px-6 md:px-10 lg:px-20">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white p-5 sm:p-6 md:p-8 rounded-lg shadow-md space-y-5">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs sm:text-sm text-gray-600">
                  Jhajhra near Subharti Hospital Chakrata Road, Dehradun,
                  Uttarakhand 248001
                </p>
                <a
          ...
          <form
            ...
            className="bg-white p-5 sm:p-6 md:p-8 rounded-lg shadow-md space-y-4"
          >
