  ...
  return (
    <div className="relative w-full min-h-[100dvh] overflow-hidden">
      ...
      <div className="relative z-20 flex flex-col justify-start items-center text-center text-white min-h-[100dvh] px-6 pt-[18rem]">
        ...
        {/* Form */}
        <div className="bg-white text-gray-700 p-4 rounded-lg shadow-lg flex flex-col md:flex-row items-center w-full max-w-lg md:max-w-4xl gap-4">
          {/* Location */}
          <div className="flex flex-col w-full">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full border border-gray-300 rounded-md pl-10 pr-3 py-2 bg-white text-sm md:text-base outline-none"
                value={location}
