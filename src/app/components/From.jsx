...
export default function Form() {
  ...
  return (
    <div className="relative w-full min-h-screen md:min-h-[100dvh] bg-black">
      {/* Background Slides */}
      {slides.map((slide, index) => (
        <div
          key={index}
          className={`fixed top-0 left-0 w-full h-full bg-cover bg-center transition-opacity duration-1000 ease-in-out will-change-transform ${
      ...
      {/* Content */}
      <div className="relative z-20 flex flex-col justify-start items-center text-center text-white min-h-screen md:min-h-[100dvh] px-6 pt-[18rem]">
        {/* Title */}
        <div className="mb-4">
          ...
          <div className="flex flex-col col-span-1">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full border border-gray-300 rounded-md pl-10 pr-3 py-2 bg-white text-[16px] min-h-[44px] outline-none appearance-none"
                value={location}
