...
//   const { openForm } = useStayForm(); // <-- Get the openForm method from context
...
//                 }}
//                 className="block w-full bg-[#f54a00a1] text-white text-center py-2 rounded-full hover:bg-[#F54900] transition"
//               >
//                 Book Your Stay
//               </Link>
//             </li>
