...
//         {teamMembers.map((member, index) => (
//           <SwiperSlide key={index}>
//             <div className="rounded-2xl overflow-hidden bg-white shadow-md hover:shadow-xl transition-all duration-300 flex flex-col h-full">
//               <div className="w-full h-[300px] md:h-[320px] overflow-hidden">
//                 <img
//                   src={member.image}
//                   alt={member.name}
...
//                   <p className="text-sm text-orange-600 font-semibold mt-1 mb-3">{member.role}</p>
//                   <p className="text-sm text-gray-600">{member.bio}</p> 
//                 </div>

//                 <div className="mt-4 flex justify-center gap-5 text-xl text-gray-500">
//                   <a href={member.linkedin} target="_blank" rel="noopener noreferrer">
//                     <FaLinkedin className="hover:text-blue-600 transition" />
//                   </a>
//                   <a href={member.twitter} target="_blank" rel="noopener noreferrer">
