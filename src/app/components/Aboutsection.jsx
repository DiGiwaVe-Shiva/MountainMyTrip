...
export default function Aboutsection() {
  return (
    <section className="px-4 sm:px-8  py-12 md:py-8 flex flex-col md:flex-row items-center justify-between max-w-7xl mx-auto">
      {/* Text Section */}
      <div className="w-full md:w-1/2 text-center md:text-left">
        <h2 className="text-xl  md:text-2xl sm:text-xl text-orange-500 font-bold uppercase tracking-wide">
          About Us
        </h2>
        <h3 className="text-2xl sm:text-3xl md:text-3xl font-bold mt-2 text-gray-900">
          Experience the Thrill of Mountain Trekking in India
        </h3>
